...
var (
	...
	ValidationAttempts = telemetry.NewGaugeWithOpts("admission_webhooks", "validation_attempts",
		[]string{"validation_type", "status", "validated", "error"}, "Number of pod validation attempts by validation type",
		telemetry.Options{NoDoubleUnderscoreSep: true})
	MutationAttempts = telemetry.NewGaugeWithOpts("admission_webhooks", "mutation_attempts",
		...
		telemetry.Options{NoDoubleUnderscoreSep: true})
	ValidatingWebhooksReceived = telemetry.NewCounterWithOpts("admission_webhooks", "webhooks_received",
		[]string{"validation_type"}, "Number of webhook requests received.",
		telemetry.Options{NoDoubleUnderscoreSep: true})
	...
	GetOwnerCacheMiss = telemetry.NewGaugeWithOpts("admission_webhooks", "owner_cache_miss",
		...
		telemetry.Options{NoDoubleUnderscoreSep: true})
	ValidatingWebhooksResponseDuration = telemetry.NewHistogramWithOpts(
		"admission_webhooks",
		"response_duration",
