...
// Kubernetes API server and either validate or refuse the Kubernetes objects before the operation
...
// if they don't respect specific A typical example is to intercept
