...
func (w *WebhookForPods) WebhookFunc() func(request *admission.Request) *admiv1.AdmissionResponse {
...
func (w *WebhookForCommands) WebhookFunc() func(request *admission.Request) *admiv1.AdmissionResponse {
	return w.admissionFunc
}
