...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.56.0-rc.9
	...
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.56.0-rc.9
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/secrets v0.56.0-rc.9
	...
	github.com/DataDog/datadog-agent/comp/def v0.56.0-rc.9
	...
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline/logsagentpipelineimpl v0.56.0-rc.9
	...
	github.com/DataDog/datadog-agent/comp/trace/compression/def v0.56.0-rc.9
	...
	github.com/DataDog/datadog-agent/pkg/collector/check/defaults v0.56.0-rc.9
	github.com/DataDog/datadog-agent/pkg/config/env v0.56.0-rc.9
	...
	github.com/DataDog/datadog-agent/pkg/config/utils v0.56.0-rc.9
	...
	github.com/DataDog/datadog-agent/pkg/logs/processor v0.56.0-rc.9
	github.com/DataDog/datadog-agent/pkg/logs/sds v0.56.0-rc.9
	github.com/DataDog/datadog-agent/pkg/logs/sender v0.56.0-rc.9
	github.com/DataDog/datadog-agent/pkg/logs/sources v0.56.0-rc.9
	github.com/DataDog/datadog-agent/pkg/logs/status/utils v0.56.0-rc.9
	...
	github.com/DataDog/datadog-agent/pkg/util/system v0.56.0-rc.9
